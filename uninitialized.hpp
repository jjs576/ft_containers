...
namespace ft
{
	...
	{
		return ft::copy(__first, __last, __result);
	}
	...
	inline _ForwardIterator __uninitialized_copy_aux(_InputIterator __first, _InputIterator __last, _ForwardIterator __result, __false_type)
	{
		...
		try
		{
			for (; __first != __last; ++__first, ++__cur)
				ft::_Construct(&*__cur, *__first);
			return __cur;
		}
		catch (...)
		{
			ft::_Destroy(__result, __cur);
			throw;
		}
	}
	...
	inline _ForwardIterator uninitialized_copy(_InputIterator __first, _InputIterator __last, _ForwardIterator __result)
	{
		...
		return ft::__uninitialized_copy_aux(__first, __last, __result, _Is_POD());
	}
	...
	__uninitialized_fill_aux(_ForwardIterator __first, _ForwardIterator __last, const _Tp &__x, __false_type)
	{
		...
		try
		{
			for (; __cur != __last; ++__cur)
				ft::_Construct(&*__cur, __x);
		}
		catch (...)
		{
			ft::_Destroy(__first, __cur);
			throw;
		}
	}
	...
	uninitialized_fill(_ForwardIterator __first, _ForwardIterator __last, const _Tp &__x)
	{
		typedef typename iterator_traits<_ForwardIterator>::value_type _ValueType;
		typedef typename is_scalar<_ValueType>::__type _Is_POD;
		ft::__uninitialized_fill_aux(__first, __last, __x, _Is_POD());
	}
	...
	inline void uninitialized_fill_n(_ForwardIterator __first, _Size __n, const _Tp &__x)
	{
		typedef typename iterator_traits<_ForwardIterator>::value_type _ValueType;
		typedef typename is_scalar<_ValueType>::__type _Is_POD;
		ft::__uninitialized_fill_n_aux(__first, __n, __x, _Is_POD());
	}
	...
	{
		return ft::uninitialized_copy(__first, __last, __result);
	}
	...
	{
		ft::uninitialized_fill(__first, __last, __x);
	}
	...
	{
		ft::uninitialized_fill_n(__first, __n, __x);
	}
	...
	{
		_ForwardIterator __mid = ft::__uninitialized_copy_a(__first1, __last1, __result, __alloc);
		try
		{
			return ft::__uninitialized_copy_a(__first2, __last2, __mid, __alloc);
		}
		catch (...)
		{
	...
	{
		ft::__uninitialized_fill_a(__result, __mid, __x, __alloc);
		try
		{
			return ft::__uninitialized_copy_a(__first, __last, __mid, __alloc);
		}
		catch (...)
		{
			ft::_Destroy(__result, __mid, __alloc);
	...
	inline void __uninitialized_copy_fill(_InputIterator __first1, _InputIterator __last1, _ForwardIterator __first2, _ForwardIterator __last2, const _Tp &__x, _Allocator __alloc)
	{
		...
		try
		{
			ft::__uninitialized_fill_a(__mid2, __last2, __x, __alloc);
		}
		catch (...)
		{
